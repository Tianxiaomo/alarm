...
//    char file[BUFFER_SIZE] = {'\0'};  
    ...
    char* post = (char*)os_malloc(BUFFER_SIZE);
    char* lpbuf = (char*)os_malloc(BUFFER_SIZE*4);
    char* host_addr = (char*)os_malloc(BUFFER_SIZE);
    char* file = (char*)os_malloc(BUFFER_SIZE);

    memset(post,'\0',BUFFER_SIZE);
    memset(lpbuf,'\0',BUFFER_SIZE*4);
    memset(host_addr,'\0',BUFFER_SIZE);
